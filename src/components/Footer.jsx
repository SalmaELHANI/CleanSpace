...
const socialLinks = [
    {
        label: "Whatsapp", className: "mx-2", svgWidth: 35, svgHeight: 35, url: "https://wa.me/0623558553" ,
        svgLink: 
        <g>
    ...
    {
        label: "Instagram", className: "mx-2", svgWidth: 35, svgHeight: 35, url: "https://www.instagram.com/salmaelhanii?igsh=dzZoNTl3aDBrb3I2" , 
        svgLink: 
        <g>
    ...
    {
        label: "Facebook", className: "mx-2", svgWidth: 33, svgHeight: 33, url: "https://www.facebook.com/salma.hani.9480?mibextid=ZbWKwL" ,
        svgLink: 
        <g> 
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 sm:gap-y-10 lg:grid-cols-5">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col items-start mt-5 space-y-2">
                            ...
                            <a href="tel:0623558553" className="text-gray-600 transition-colors duration-300  hover:text-blue-700 hover:font-black" aria-label="WhatsApp">(+212)6 23 55 85 53</a>
                            <a href="mailto:contact@example.com" className="text-gray-600 transition-colors duration-300 hover:text-blue-700 hover:font-black" aria-label="Email">CleanSpace@gmail.com</a>
                        </div>
                    </div>
                </div>
